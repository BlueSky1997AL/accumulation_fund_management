...
import { AmountInfo, EnterpriseFundRemitSubmitData } from '~components/fundRemitWorkflow/enterpriseFundRemitForm';
...
function EnterpriseFundRemit ({ workOrder, labelSpan, contentSpan }: EnterpriseFundRemitProps) {
